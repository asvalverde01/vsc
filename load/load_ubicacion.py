...
def cargar_dim_ubicacion():
    ...
    try:
        ...
        ubicacion_tra = pd.read_sql("SELECT * FROM tra_Ubicacion", ses_db_stg)
        ...
        table_name_sor = 'Dim_Ubicacion'

        # Fusionar (merge) los datos transformados en la tabla Dim_Ubicacion de sor
        ubicacion_tra.to_sql(table_name_sor, ses_db_sor, if_exists='replace', index=False, method='multi')
