...
def cargar_dim_proveedor():
    ...
    try:
        ...
        proveedor_tra = pd.read_sql("SELECT * FROM tra_Proveedor", ses_db_stg)
        ...
        table_name_sor = 'Dim_Proveedor'

        # Fusionar (merge) los datos transformados en la tabla Dim_Proveedor de sor
        proveedor_tra.to_sql(table_name_sor, ses_db_sor, if_exists='replace', index=False, method='multi')
